...
while (true)
    ...
    archNet = setwb(archNet,calcLib.getwb(calcNet));
    tr = worker.tr;
...
while (true)
    ...
    spmd
        ...
        if calcLib.isMainWorker
            ...
            mainC.WB = calcLib.getwb(calcNet); %workerC.WB;
        end
    end
    ...
    archNet = setwb(archNet,main.WB);
    tr = main.tr;
    
    feedback.updateOutsideSPMD(archNet,tr, ...
