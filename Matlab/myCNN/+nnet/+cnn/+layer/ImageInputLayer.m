...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Added iIsValidAnyChannelImageSize(sz)
tf = iIsPositiveIntegerRowVectorOfTwoOrThree(sz) && ...
    (iIsValidGrayscaleImageSize(sz) || iIsValidRGBImageSize(sz) || iIsValidAnyChannelImageSize(sz));
end
...
function tf = iIsValidAnyChannelImageSize(sz)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Set any number of amount of image channels as valid
tf = numel(sz) == 3 && sz(end) > 0;
end
