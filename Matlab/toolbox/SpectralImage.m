classdef SpectralImage
    ...
    properties
        ...
        % With 875-short filter
%         wavelengthsRowMajor = [615, 623, 608, 600, 686,...
%             816, 828, 803, 791, 700,...
%             765, 778, 752, 739, 714,...
%             653, 662, 645, 636, 678,...
%             867, 864, 857, 845, 670];
        ...
        % No filter
        wavelengthsRowMajor = [907, 915, 898, 889, 974,...
            816, 828, 803, 791, 700,...
            765, 778, 753, 739, 714,...
            948, 954, 938, 931, 968,...
            868, 878, 857, 845, 965];
    ...
    methods
        ...
        function obj = createResponseCorrectedCube(obj, inverseSensorResponse, darkNoiseImg)
            obj.responseCorrectedCube = SpectralImage(inverseSensorResponse(1+obj.rawImage) - darkNoiseImg).dataCube;
