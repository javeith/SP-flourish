function [ unImg ] = undistort_cameraParams( img, cameraParams, model )
% model = [radtan4, radtan5, fisheye, equidistant]

% Extract camera matrix & distortion coefficients
cameraMatrix = cameraParams.IntrinsicMatrix';
distortion = [cameraParams.RadialDistortion cameraParams.TangentialDistortion];
