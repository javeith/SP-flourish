...
inputArguments.FilterSize = iMakeIntoRowVectorOfTwo(params.FilterSize);
inputArguments.NumFilters = params.NumFilters;
...
inputArguments.NumChannels = iConvertToEmptyIfAuto(params.NumChannels);
