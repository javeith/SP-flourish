classdef UserCallbackReporter < nnet.internal.cnn.util.Reporter
    ...
    methods
        ...
        function reportIteration( this, summary )
            % Edit the Info struct with fields from summary input
            ...
            % Add state to info and call callbacks
            this.Info.State = "iteration";
            this.callCallbacks();
        end
        ...
        function finish( this )
            % Add state into current info (unchanged) and call callbacks
