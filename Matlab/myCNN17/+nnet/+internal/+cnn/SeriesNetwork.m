classdef SeriesNetwork < nnet.internal.cnn.TrainableNetwork
    ...
    methods
        ...
        function [gradients, predictions, states, this] = computeGradientsForTraining(this, X, Y, needsStatefulTraining, propagateState)
            ...
            function gradientsThisLayer = efficientBackProp(currentLayer)
                ...
                [dX,gradientsThisLayer] = this.Layers{currentLayer}.backward( ...
                    layerOutputs{currentLayer-1}, layerOutputs{currentLayer}, ...
