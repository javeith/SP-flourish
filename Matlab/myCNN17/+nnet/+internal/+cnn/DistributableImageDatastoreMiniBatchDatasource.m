classdef DistributableImageDatastoreMiniBatchDatasource < nnet.internal.cnn.DistributableMiniBatchDatasource
    ...
    methods
        ...
        % the given proportions
            ...
            [ dsPartitions, subBatchSizes ] = ...
                iSplitDatastore( this.imds, this.MiniBatchSize, proportions );
            ...
            for p = 1:numPartitions
                distributedData{p} = nnet.internal.cnn.ImageDatastoreMiniBatchDatasource( ...
                    dsPartitions{p}, ...
                    subBatchSizes(p));
            end
        end
