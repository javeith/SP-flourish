...
if ~isequal( classX, classZ )
    iThrow( 'nnet_cnn:internal:cnn:layer:util:CustomLayerVerifier:PredictInvalidType', layerClass, classX, classZ )
end
end
...
for ii=1:numel(learnableParametersNames)
    ...
    if ~isequal( classdLdW, classX )
        iThrow( 'nnet_cnn:internal:cnn:layer:util:CustomLayerVerifier:dLdWInvalidType', learnableParametersNames{ii}, layerClass, classX, classdLdW )
    end
end
end
