classdef DistributableInMemoryTableMiniBatchDatasource < nnet.internal.cnn.DistributableMiniBatchDatasource
    ...
    methods
        ...
        % the given proportions
            ...
            for p = 1:numPartitions
                distributedData{p} = nnet.internal.cnn.InMemoryTableMiniBatchDatasource( ...
