classdef RegressionAxesFactory < nnet.internal.cnn.ui.factory.AxesFactory
    ...
    methods        
        function [axesView, metrics] = createMainAxesAndMetrics(~, epochInfo, epochDisplayer)      
            ...
            metrics{1} = nnet.internal.cnn.ui.metric.Metric(trainingUpdateableSeries, 'RMSE');
            metrics{2} = nnet.internal.cnn.ui.metric.Metric(validationUpdateableSeries, 'ValidationRMSE');
