classdef DistributableFourDArrayMiniBatchDatasource < nnet.internal.cnn.DistributableMiniBatchDatasource
    ...
    methods
        ...
        function [distributedData, subBatchSizes] = distribute( this, proportions )
            ...
            [ partitionedData, partitionedResponse, subBatchSizes ] = ...
                iSplitData( this.Input, this.Response, this.MiniBatchSize, ...
            ...
            for p = 1:numPartitions
                distributedData{p} = nnet.internal.cnn.FourDArrayMiniBatchDatasource( ...
                    partitionedData{p}, partitionedResponse{p},subBatchSizes(p));
            end
        end 
    end  
end
