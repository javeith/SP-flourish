classdef TransposedConvolution2DLayer < nnet.cnn.layer.Layer & nnet.internal.cnn.layer.Externalizable
    % TransposedConvolution2DLayer   2-D transposed convolution layer
    %
    %   To create a transposed convolution layer, use
    ...
    methods
        function this = TransposedConvolution2DLayer(privateLayer)
...
internalLayer = nnet.internal.cnn.layer.TransposedConvolution2D( ...
...
obj = nnet.cnn.layer.TransposedConvolution2DLayer(internalLayer);
end
