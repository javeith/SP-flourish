...
%% Inputs needed:
% - colored Point cloud
pcName = [hddLoc 'thanujan/Datasets/xClassifier/x41bands/PatternNet/testSet_FIP_170622_PatternNet.ply'];

% - Intrinsic parameters (.yaml)
camyaml = [hddLoc 'thanujan/Datasets/Ximea_Tamron/20170613/intrinsics_ximea.yaml'];

% - Ximea?
ximea = 1;

% - Output name:
output = [hddLoc 'thanujan/Datasets/xClassifier/x41bands/PatternNet/testSet_FIP_170622_PatternNet.png'];
