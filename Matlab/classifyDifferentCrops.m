...
% TRAINING 01:
for iBand = 1:25
    corn1_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Corn1/NIR25/band'  num2str(iBand) '.ply']);
    size1 = size(corn1_pc.Color,1);
    corn(iBand,1:size1) = corn1_pc.Color(:,1);
    clear corn1_pc;
    
    corn2_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Corn2/NIR25/band'  num2str(iBand) '.ply']);
    corn(iBand,(size1+1):(size1+size(corn2_pc.Color,1))) = corn2_pc.Color(:,1);
    clear corn2_pc size1;
    
    sugarBeet_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Sugarbeet/NIR25/band'  num2str(iBand) '.ply']);
    sugarBeet(iBand,:) = sugarBeet_pc.Color(:,1);
    clear sugarBeet_pc;
    
    winterWheat1_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Winterwheat1/NIR25/band'  num2str(iBand) '.ply']);
    size2 = size(winterWheat1_pc.Color,1);
    winterWheat(iBand,1:size2) = winterWheat1_pc.Color(:,1);
    clear winterWheat1_pc;
    
    winterWheat2_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Winterwheat2/NIR25/band'  num2str(iBand) '.ply']);
    winterWheat(iBand,(size2+1):(size2+size(winterWheat2_pc.Color,1))) = winterWheat2_pc.Color(:,1);
    clear winterWheat2_pc size2;
    
    buckWheat_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Buckwheat/NIR25/band'  num2str(iBand) '.ply']);
    buckWheat(iBand,:) = buckWheat_pc.Color(:,1);
    clear buckWheat_pc;
    
    grass_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Grass/NIR25/band'  num2str(iBand) '.ply']);
    grass(iBand,:) = grass_pc.Color(:,1);
    clear grass_pc;
    
    road_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/road/NIR25/band'  num2str(iBand) '.ply']);
    road(iBand,:) = road_pc.Color(:,1);
    clear road_pc;
    
    soil_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/soil/NIR25/band'  num2str(iBand) '.ply']);
    soil(iBand,:) = soil_pc.Color(:,1);
    clear soil_pc;
    
    soy_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Soybean/NIR25/band'  num2str(iBand) '.ply']);
...
for iBand = 1:16
    ...
    winterWheat2_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Winterwheat2/VIS16/band'  num2str(iBand) '.ply']);
    winterWheat(iBand+25,(size2+1):(size2+size(winterWheat2_pc.Color,1))) = winterWheat2_pc.Color(:,1);
    clear winterWheat2_pc size2;
    
    buckWheat_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Buckwheat/VIS16/band'  num2str(iBand) '.ply']);
    buckWheat(iBand+25,:) = buckWheat_pc.Color(:,1);
    clear buckWheat_pc;
    
    grass_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Grass/VIS16/band'  num2str(iBand) '.ply']);
    grass(iBand+25,:) = grass_pc.Color(:,1);
    clear grass_pc;
    
    road_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/road/VIS16/band'  num2str(iBand) '.ply']);
    road(iBand+25,:) = road_pc.Color(:,1);
    clear road_pc;
    
    soil_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/soil/VIS16/band'  num2str(iBand) '.ply']);
    soil(iBand+25,:) = soil_pc.Color(:,1);
    clear soil_pc;
    
    soy_pc = plyread([hddLoc 'thanujan/Datasets/xClassifier/trainSet/Soybean/VIS16/band'  num2str(iBand) '.ply']);
